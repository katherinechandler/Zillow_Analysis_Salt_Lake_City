...
Small home enthusiasts maintain that small homes are a great asset, but is this economic reality? Is a small urban home *really* a better investment than a large suburban home? The analysis presented in this repository explores this question using current and historical real estate prices for the Salt Lake City area obtained from the real estate market place Zillow.
...
[Zillow_SLC_Analysis_Walkthrough.Rmd](https://github.com/katherinechandler/Zillow_Analysis_Salt_Lake_City/blob/master/Zillow_SLC_Analysis_Walkthrough.Rmd)

The Zillow_SLC_Analysis_Walkthrough file is a project walk through of the Zillow real estate analysis. A complete walkthrough with analysis code and additional commentary is in the 'Zillow_Project2_Walk_Through.ipynb' file located in the 'zillow_analysis_notebooks'.
